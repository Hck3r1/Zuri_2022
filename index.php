...
<body>
    <form name="registration" method="post" action="user_data.php">
        ...
        <select name="gender" id="gender" required><span style="color: red !important; display: inline; float: none;">*</span> 
